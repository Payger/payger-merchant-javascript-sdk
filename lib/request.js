...
export default class Request {
	...
	put(token = null, url, data = {}, contentType = "application/json; charset=utf-8") {
		return this.postOrPut(token, url, null, data, this.methods.put, contentType);
	}
	...
	async postOrPut(token = null, url, basicAuth = null, data, method, contentType){
		const basicAuthorization = basicAuth != null ? "Basic " + Base64.encode(basicAuth.user + ":" + basicAuth.psw) : ""; 
		const headers = {
